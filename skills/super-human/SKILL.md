...
slug: super-human
version: 2.0.0
description: "全能超人 v2.0 - 融合 BMAD敏捷开发 + Open Design快速原型 + superpowers + agency + design + memory。支持敏捷开发全流程、31种设计原型、72个设计系统。"
...
- ✅ **Open Design快速原型** - 31种设计原型技能，72个设计系统，快速生成专业设计
...
### 4. Open Design 快速原型模式（新增）

**触发词**: 「原型」、「设计系统」、「落地页」、「Dashboard」、「邮件营销」
...
- **mobile-app** - 移动应用
- **pricing-page** - 定价页面
- **social-carousel** - 社交媒体轮播
- **magazine-poster** - 杂志海报

**72个设计系统**（部分列表）:
- **default** - Neutral Modern（默认）
...
**示例**:
```
用户：用Apple设计系统做一个SaaS落地页
AI：[Open Design流程]
  1. 加载Apple设计系统（design-systems/apple/DESIGN.md）
  2. 使用saas-landing技能模板
  3. 生成符合Apple美学的落地页原型
  4. 提供HTML预览和代码
```
...
**原冲突**: Open Design有31个独立技能，可能与design技能的偏好学习冲突

**优化方案**:
- **技能分层**: 
  - Open Design作为**快速原型层**（生成初始原型）
  - design技能作为**偏好优化层**（迭代和优化）
- **设计系统复用**: Open Design的72个设计系统作为design技能的预设偏好
- **工作流集成**: 
